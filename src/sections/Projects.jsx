      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 mt-4">
            {language === 'id' ? "Berikut adalah Beberapa Project yang pernah saya kerjakan." : "Here are some of the projects I've worked on."}
          </p>
        </motion.div>

        {/* Flex Project (untuk center item ganjil) */}
        {/* Flex Project (untuk center item ganjil) */}
        {projects[language].length > 0 ? (
          ...
          <div className="text-center py-20 bg-white/[0.02] border border-white/[0.05] rounded-3xl backdrop-blur-md">
            <h3 className="text-2xl font-bold text-gray-300 mb-2">{language === 'id' ? "Belum Ada Project Web" : "No Web Projects Yet"}</h3>
            <p className="text-gray-500">{language === 'id' ? "Silakan tambahkan data project web asli Anda di file" : "Please add your real web project data in file"} <code className="text-blue-400 bg-blue-500/10 px-2 py-1 rounded">src/data/index.js</code></p>
          </div>
        )}
